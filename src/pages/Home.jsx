      ...
      <div className="container page">
        <div className="row">
          <div className="col-md-9">
            ...
            {_.isEmpty(articles) && articlesQuery.isFetched && (
              <div className="article-preview">No articles to show... Wanna be the first to post?</div>
            )}
          ...
          <div className="col-md-3">
            <div className="sidebar">
              ...
              {_.isEmpty(tags) && tagsQuery.isFetched && <div>No tags are here... yet.</div>}
            </div>
          </div>
        </div>
      </div>
